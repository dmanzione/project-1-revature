...
public class HomeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter()
				.write("<!DOCTYPE html><html><title>The Pirate Store Chain</title>\n"
						...
						+ "          </span>\n"
						+ "          <span class=\"w3-bar-item w3-margin-right \">Home: <span class=\"w3-codespan w3-text-black\">/revpirates/</span>\n"
						+ "          </span>\n"
						+ "          </span>\n"
						+ "        </div>\n"
						+ "  \n"
						...
						+ "<div class=\"w3-container w3-padding w3-bar-block\">\n"
						+ "          <span class=\"w3-bar-item w3-margin-right \">Home: <span class=\"w3-codespan w3-text-black\"> GET /revpirates/home</span></span>\n"
						+ "\n"
						...
						+ "          <span class=\"w3-bar-item w3-margin-right \">See particular product: <span class=\"w3-codespan w3-text-black\">GET /revpirates/stores/{location}/inventory/{productName}</span>\n"
						+ "          </span>\n"
						+ "\n"
						...
						+ "          </span><span class=\"w3-bar-item w3-margin-right \">All orders in a location: <span class=\"w3-codespan w3-text-black\"> GET/revpirates/stores/{location}/orders</span>\n"
						+ "          </span>\n"
